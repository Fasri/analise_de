...
QUANTIDADE_PROCESSOS_PJE = "quantidade_processos.xlsx"
    ...
    if data_tempo_real:
        ...
        if escolha == "Baixar":
            with open(ARQUIVO_TEMPO_REAL, "rb") as file:
                st.download_button("📥 Baixar Arquivo", file, file_name="final_tempo_real.xlsx", mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
        else:
